...
- [Legend](#legend)
- [Official HashiCorp Terraform Resources](#official-hashicorp-terraform-resources)
- [Community](#community)
- [Resources](#resources)
  - [Books](#books)
...
- [Tools & Services](#tools--services)
  - [General Tools & Services](#general-tools--services)
...
- Language-specific communities:
  - [Telegram (Ukrainian speaking community)](https://t.me/terraform_ukraine)

## Resources

### Books

Books published on Terraform, listed in alphabetical order with published date and book's description.

- [Big Little Book On Terraform: Terraform in minutes not hours](https://www.amazon.com/Big-Little-Book-Terraform-Omos-ebook/dp/B07PWYPNX8/) (2019) - This book is for IT professionals working hard to keep up with new technology whilst retaining old skills learnt.
- [Bootstrapping Microservices with Docker, Kubernetes, and Terraform](https://www.manning.com/books/bootstrapping-microservices-with-docker-kubernetes-and-terraform) (2021) - Guides you from zero through to a complete microservices project, including fast prototyping, development, and deployment.
- [Deep-Dive Terraform on Azure](https://link.springer.com/book/10.1007/978-1-4842-7328-9) (2021) - Presents best practices in Terraform and security.
- [Getting Started with Terraform - 2nd Edition: Manage production infrastructure as a code](https://www.amazon.com/Getting-Started-Terraform-production-infrastructure/dp/1788623533/) (2017) - This book shows you when and how to implement infrastructure as a code practices with Terraform.
...
- [The Terraform Book](https://terraformbook.com/) (2016) - A hands-on, introductory book about managing infrastructure with HashiCorp's Terraform tool.

### Tutorials and Blog Posts

#### Beginner Guides

- [A Comprehensive Guide to Terraform](https://blog.gruntwork.io/a-comprehensive-guide-to-terraform-b3d32832baca) (2016) - Series of blog posts from the author of "Terraform: Up & Running" that guide the reader from beginning with Terraform to using it in the real world.
- [Using Terraform for Cloud Deployments - Part 1](https://dev.to/koenighotze/using-terraform-for-cloud-deployments---part-1) (2017) - Provisioning an EC2 instance.
- [Hello, world: The Fargate/Terraform tutorial I wish I had](https://section411.com/2019/07/hello-world/) (2021) - Blog post describing setting up an ECS Fargate cluster from scratch
- [Terraform Best Practices](https://www.terraform-best-practices.com/) (actively updated) - [open-source ebook](https://github.com/antonbabenko/terraform-best-practices) describing best practices when using Terraform

#### How-To

- [Deploying Discourse with Terraform](https://www.hashicorp.com/blog/deploying-discourse-with-terraform) (2014) - Shows how Terraform can create a running instance of Discourse on DigitalOcean in one command.
- [Deploying Django to AWS ECS with Terraform](https://testdriven.io/blog/deploying-django-to-ecs-with-terraform/) (2021) - Looks at how to use Terraform to spin up the required AWS infrastructure for running a Django app on ECS.
- [Easily Deploy A Seneca Microservice to ECS with Wercker and Terraform: Part I](http://chiefy.github.io/easily-deploy-a-seneca-microservice-to-ecs-with-wercker-and-terraform-part-i/), [II](http://chiefy.github.io/easily-deploy-a-seneca-microservice-to-ecs-with-wercker-and-terraform-part-ii/) & [III](http://chiefy.github.io/easily-deploy-a-seneca-microservice-to-ecs-with-wercker-and-terraform-part-i/) (2016) - Illustrates how Terraform can be incorporated into a microservice deployment pipeline.
- [Google Cloud Platform for 10$ a month using terraform](https://github.com/nufailtd/terraform-budget-gcp) (2021) - Shows how to use terraform to create a secure Google Kubernetes Cluster, Google Cloud Run Services and other infrastructure elements for less than [10$](https://nufailtd.github.io/budget-gcp/) a month.
- [How To Write OPA for Terraform](https://www.scalr.com/blog/opa-series-part-1-open-policy-agent-and-terraform/) (2020) - How to use Open Policy Agent to evaluate and enforce policy on your Terraform plans
- [Infracost + Terraform + GitHub Actions = Automate Cloud Cost Management](https://betterprogramming.pub/infracost-terraform-github-actions-automate-cloud-cost-management-a62b329f2834?sk=495131c5831bc9276369150da5f3bc2c) (2022) - How to use Infracost as the guardrail to manage cloud costs during Terraform development.
- [Terraform for a Highly Available VPN between AWS and Azure](https://web.archive.org/web/20210616132857/https://deployeveryday.com/2020/04/13/vpn-aws-azure-terraform.html) (2020) - Terraform code to deploy a highly available VPN between AWS and Azure.
- [Terraforming 1Password](https://blog.agilebits.com/2018/01/25/terraforming-1password/) (2018) - How 1Password migrated from CloudFormation to Terraform.
- [Tutorial: How to Use Terraform to Deploy OpenStack Workloads](https://web.archive.org/web/20170611135511/http://www.stratoscale.com/blog/openstack/tutorial-how-to-use-terraform-to-deploy-openstack-workloads/) (2016) - Illustrates how easy it is to use the OpenStack Terraform provider to deploy a web server.
- [Zero Downtime Updates with HashiCorp Terraform](https://www.hashicorp.com/blog/zero-downtime-updates-with-terraform) (2018) - Ensuring zero downtime of your infrastructure.

#### Cloud Providers

##### Azure

- [Learning HashiCorp Terraform](https://web.archive.org/web/20201108000713/https://www.g10s.io/hashicorp-terraform/) (2019) - Guide for Azure.
- [New Terraform Azure Automation Resources](https://bgelens.nl/terraform-automation-resources/) (2019) - Azure Automation.
- [Terraforming Azure PaaS](https://devkimchi.com/2019/01/21/terraforming-azure-paas/) (2019) - Deploy PaaS Resources on Azure.

##### AWS

- [AWS Lambda the Terraform Way](https://github.com/nsriram/lambda-the-terraform-way) (2021) - Understand AWS Lambda in-depth, beyond executing functions, using Terraform. Also includes guides for integration with S3, API Gateway, DynamoDB, Kinesis, SQS.
- [Managing AWS Lambda Functions with Terraform](https://spacelift.io/blog/terraform-aws-lambda) (2022) - What is AWS Lambda used for and how to use Terraform to manage AWS Lambda functions?
- [Terraform: Beyond the Basics with AWS](https://aws.amazon.com/blogs/apn/terraform-beyond-the-basics-with-aws/) (2018) - Explanation of a demo using Terraform to provision a sample AWS architecture.

##### Google Cloud

- [Managing infrastructure as code with Terraform, Cloud Build, and GitOps](https://cloud.google.com/architecture/managing-infrastructure-as-code) (2019) - Setup and manage infrastructure as code with Terraform, Cloud Build, and GitOps.
- [Getting started with Terraform on Google Cloud](https://cloud.google.com/community/tutorials/getting-started-on-gcp-with-terraform) (2022) - Using Terraform to create a VM in Google Cloud and Starting a basic Python Flask server.
...
- [Terraform Design Patterns: the Terrafile](http://bensnape.com/2016/01/14/terraform-design-patterns-the-terrafile/) (2016) - Managing Terraform modules and their versions within Terraform projects with Terrafile.
- [Terraform, VPC, and why you want a tfstate file per env](https://charity.wtf/2016/03/30/terraform-vpc-and-why-you-want-a-tfstate-file-per-env/) (2016) - Some gotchas surrounding using Terraform in large projects with multiple environments and how to avoid them.
- [Using Pipelines to Manage Environments with Infrastructure as Code](https://medium.com/@kief/https-medium-com-kief-using-pipelines-to-manage-environments-with-infrastructure-as-code-b37285a1cbf5) (2016) - Explains different approaches for building a pipeline to handle infrastructure changes moving from one environment to the next.
- [Sharing data between Terraform configurations](https://jamesmckay.net/2016/09/sharing-data-between-terraform-configurations/) (2016) - Illustrates how to use remote state to share data between Terraform configurations.

#### Security & Compliance

- [How To Write OPA for Terraform](https://www.scalr.com/blog/opa-series-part-1-open-policy-agent-and-terraform/) (2020) - How to use Open Policy Agent to evaluate and enforce policy on your Terraform plans.
- [HashiCorp Learn: Enforce Policy with HashiCorp Sentinel](https://learn.hashicorp.com/collections/terraform/policy) - Enforce policies before your users create infrastructure using Sentinel policy-as-code, included in the Terraform Cloud Team and Governance tier. Write, test, and implement Sentinel policies.

#### Testing & Troubleshooting

- [Top 3 Terraform Testing Strategies for Ultra-Reliable Infrastructure-as-Code](https://www.contino.io/insights/top-3-terraform-testing-strategies-for-ultra-reliable-infrastructure-as-code) (2017)
- [How to Debug Terraform Projects: Tutorial](https://spacelift.io/blog/terraform-debug) (2021)

#### Writing Custom Providers

- [Creating custom terraform providers](https://medium.com/@jozmo/creating-custom-terraform-providers-341311823fa2) (2018) - Guide for creating custom providers.
- [Writing a Terraform provider](https://web.archive.org/web/20220516140659/http://blog.jfabre.net/2017/01/22/writing-terraform-provider/) (2017) - Guide for creating custom providers.
- [HashiCorp Learn: Writing Custom Providers](https://www.terraform.io/docs/extend/writing-custom-providers.html) - Official documentation for creating custom providers.

#### Miscellaneous

- [The Segment AWS Stack](https://segment.com/blog/the-segment-aws-stack/) (2016) - Shows the behind the scenes of the infrastructure powered by Terraform that solved [The Million Dollar Engineering Problem](https://segment.com/blog/the-million-dollar-eng-problem/) at [Segment](https://segment.com/).
- [Two Weeks with Terraform](https://charity.wtf/2016/02/23/two-weeks-with-terraform/) (2016) - Some hard-earned experience from using Terraform in the wild, and some operational wisdom.
...
This section lists commonly used and interesting Terraform providers. Additional providers, including community-maintained providers, can be found in the [Terraform Provider Registry](https://registry.terraform.io/browse/providers).
...
For more modules not listed here, please see the [Terraform Module Registry](https://registry.terraform.io/browse/modules).
...
- [terraform-landscape](https://github.com/coinbase/terraform-landscape) - *(only 0.11 and earlier)* Improve Terraform's plan output to be easier to read and understand. :ghost:
