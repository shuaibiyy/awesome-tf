...
- [burrito](https://docs.burrito.tf/) - Burrito is a TACoS (Terraform Automation Collaboration Software) Kubernetes Operator.
...
- [ControlMonkey](https://web.archive.org/web/20260415123138/https://controlmonkey.io/) - Alternative to Terraform Cloud with Terraform/OpenTofu code generation, cloud inventory and IaC coverage. Includes out-of-the-box policies, drift remediation, and a ClickOps activity scanner. :heavy_dollar_sign:
